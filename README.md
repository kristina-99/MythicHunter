...
Нека героят е клас, съдържащ данни за:
    ...
    здраве - физическото здраве на героя (достигне ли 0, героят умира и играта приключва) Нека има и инвентар (контейнер, съдържащ предмети)
...
Изтриването на конзолата може да стане с командата Console.Clear();
...
Нека при преминаване през поле I то да се изчиства като празно и героят да получи предмета. След обновяването на картата на екрана отпечатете съобщение, че предметът е успешно взет. Нека полетата М и # са недостъпни за героя за сега.
