...
Нека при преминаване през поле I то да се изчиства като празно и героят да получи предмета. След обновяването на картата на екрана отпечатете съобщение, че предметът е успешно взет. Нека полетата М и # са недостъпни за геро
